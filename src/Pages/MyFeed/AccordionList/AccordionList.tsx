...
export const AccordionList = ({ list, onViewClick, onDeleteClick, onModifyClick }) => {
  return (
    <S.AccordionRoot type="single" collapsible>
      {list.map((item) => (
        <S.AccordionItem value={`item-${item.id}`}>
          <S.AccordionTrigger>
            ...
            <div className="count-section">
              <div className="group">
                <S.CommentIcon />
                <span>
                  <strong>{item.commentCount ?? item.replyCount}</strong>개
                </span>
              </div>
              ...
              <div className="group">
                <S.HeartIcon />
                <span>
                  <strong>{item.likeCount}</strong>개
                </span>
              </div>
            </div>
          </S.AccordionTrigger>
